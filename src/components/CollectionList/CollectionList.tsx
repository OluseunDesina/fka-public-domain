    ...
    <>
      <div className="flex flex-col gap-6">
        {collections.map((item, index) => (
          <div
            key={index}
            className="p-4 flex flex-col md:flex-row border rounded-lg overflow-hidden"
          >
            <img
              src={item.image}
              alt={item.title}
            ...
            <div className="p-4 flex flex-col justify-between">
              <div>
                ...
                <p className=" flex gap-2 items-center text-xs text-gray-600 mb-2">
                  <svg
                    width="20"
                    height="21"
                    viewBox="0 0 20 21"
              ...
              <div>
                <Button>
                  <Link to={"/collection-details"}>View Collection</Link>
                </Button>
              </div>
            </div>
          </div>
